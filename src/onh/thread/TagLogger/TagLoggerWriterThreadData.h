...
#ifndef TAGLOGGERTHREADWRITERDATA_H_INCLUDED
#define TAGLOGGERTHREADWRITERDATA_H_INCLUDED
...
namespace onh {
	...
	} TagLoggerWriterThreadData;

}

#endif // TAGLOGGERTHREADWRITERDATA_H_INCLUDED
