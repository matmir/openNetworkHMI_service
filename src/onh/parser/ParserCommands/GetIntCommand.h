...
#ifndef ONH_PARSER_PARSERCOMMANDS_GETINTCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_GETINTCOMMAND_H_
...
/**
 * Parser GET_INT command
 */
class GetIntCommand: public IParserCommand {
	public:
		/**
		 * GET_INT command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		GetIntCommand(std::shared_ptr<ParserDB> parserDB,
...
#endif  // ONH_PARSER_PARSERCOMMANDS_GETINTCOMMAND_H_
