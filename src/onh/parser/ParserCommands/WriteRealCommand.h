...
#ifndef ONH_PARSER_PARSERCOMMANDS_WRITEREALCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_WRITEREALCOMMAND_H_
...
/**
 * Parser WRITE_REAL command
 */
class WriteRealCommand: public IParserCommand {
	public:
		/**
		 * WRITE_REAL command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		WriteRealCommand(std::shared_ptr<ParserDB> parserDB,
		 ...
		 * Command Destructor
		 */
		virtual ~WriteRealCommand() = default;
...
#endif  // ONH_PARSER_PARSERCOMMANDS_WRITEREALCOMMAND_H_
