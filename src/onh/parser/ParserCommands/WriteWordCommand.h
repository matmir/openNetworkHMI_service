...
#ifndef ONH_PARSER_PARSERCOMMANDS_WRITEWORDCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_WRITEWORDCOMMAND_H_
...
/**
 * Parser WRITE_WORD command
 */
class WriteWordCommand: public IParserCommand {
	public:
		/**
		 * WRITE_WORD command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		WriteWordCommand(std::shared_ptr<ParserDB> parserDB,
		 ...
		 * Command Destructor
		 */
		virtual ~WriteWordCommand() = default;
...
#endif  // ONH_PARSER_PARSERCOMMANDS_WRITEWORDCOMMAND_H_
