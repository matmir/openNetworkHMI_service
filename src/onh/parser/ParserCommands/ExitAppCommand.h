...
#ifndef ONH_PARSER_PARSERCOMMANDS_EXITAPPCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_EXITAPPCOMMAND_H_
...
/**
 * Parser EXIT_APP command
 */
class ExitAppCommand: public IParserCommand {
	public:
		/**
		 * EXIT_APP command constructor
		 *
		 * @param gdcTED Thread exit controller
		 * @param commandData String with command data
		 */
		ExitAppCommand(const GuardDataController<ThreadExitData> &gdcTED,
						const std::string& commandData);

		/**
		 * Command Destructor
		 */
		virtual ~ExitAppCommand() = default;
...
#endif  // ONH_PARSER_PARSERCOMMANDS_EXITAPPCOMMAND_H_
