...
#ifndef ONH_PARSER_PARSERCOMMANDS_GETBITCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_GETBITCOMMAND_H_
...
/**
 * Parser GET_BIT command
 */
class GetBitCommand: public IParserCommand {
	public:
		/**
		 * GET_BIT command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		GetBitCommand(std::shared_ptr<ParserDB> parserDB,
...
#endif  // ONH_PARSER_PARSERCOMMANDS_GETBITCOMMAND_H_
