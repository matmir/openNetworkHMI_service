...
#ifndef ONH_PARSER_PARSERCOMMANDS_GETREALCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_GETREALCOMMAND_H_
...
/**
 * Parser GET_REAL command
 */
class GetRealCommand: public IParserCommand {
	public:
		/**
		 * GET_REAL command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		GetRealCommand(std::shared_ptr<ParserDB> parserDB,
		 ...
		 * Command Destructor
		 */
		virtual ~GetRealCommand() = default;
...
#endif  // ONH_PARSER_PARSERCOMMANDS_GETREALCOMMAND_H_
