...
#ifndef ONH_PARSER_PARSERCOMMANDS_GETBITSCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_GETBITSCOMMAND_H_
...
/**
 * Parser GET_BITS command
 */
class GetBitsCommand: public IParserCommand {
	public:
		/**
		 * GET_BITS command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		GetBitsCommand(std::shared_ptr<ParserDB> parserDB,
		 ...
		 * Command Destructor
		 */
		virtual ~GetBitsCommand() = default;
...
#endif  // ONH_PARSER_PARSERCOMMANDS_GETBITSCOMMAND_H_
