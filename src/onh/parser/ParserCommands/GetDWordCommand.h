...
#ifndef ONH_PARSER_PARSERCOMMANDS_GETDWORDCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_GETDWORDCOMMAND_H_
...
/**
 * Parser GET_DWORD command
 */
class GetDWordCommand: public IParserCommand {
	public:
		/**
		 * GET_DWORD command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		GetDWordCommand(std::shared_ptr<ParserDB> parserDB,
		 ...
		 * Command Destructor
		 */
		virtual ~GetDWordCommand() = default;
...
#endif  // ONH_PARSER_PARSERCOMMANDS_GETDWORDCOMMAND_H_
