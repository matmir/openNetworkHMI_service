...
#ifndef ONH_PARSER_PARSERCOMMANDS_SETBITCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_SETBITCOMMAND_H_
...
/**
 * Parser SET_BIT command
 */
class SetBitCommand: public IParserCommand {
	public:
		/**
		 * SET_BIT command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		SetBitCommand(std::shared_ptr<ParserDB> parserDB,
...
#endif  // ONH_PARSER_PARSERCOMMANDS_SETBITCOMMAND_H_
