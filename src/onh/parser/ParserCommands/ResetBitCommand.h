...
#ifndef ONH_PARSER_PARSERCOMMANDS_RESETBITCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_RESETBITCOMMAND_H_
...
/**
 * Parser RESET_BIT command
 */
class ResetBitCommand: public IParserCommand {
	public:
		/**
		 * RESET_BIT command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		ResetBitCommand(std::shared_ptr<ParserDB> parserDB,
		 ...
		 * Command Destructor
		 */
		virtual ~ResetBitCommand() = default;
...
#endif  // ONH_PARSER_PARSERCOMMANDS_RESETBITCOMMAND_H_
