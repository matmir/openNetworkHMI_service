...
#ifndef ONH_PARSER_PARSERCOMMANDS_WRITEDWORDCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_WRITEDWORDCOMMAND_H_
...
/**
 * Parser WRITE_DWORD command
 */
class WriteDWordCommand: public IParserCommand {
	public:
		/**
		 * WRITE_DWORD command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		WriteDWordCommand(std::shared_ptr<ParserDB> parserDB,
		 ...
		 * Command Destructor
		 */
		virtual ~WriteDWordCommand() = default;
...
#endif  // ONH_PARSER_PARSERCOMMANDS_WRITEDWORDCOMMAND_H_
