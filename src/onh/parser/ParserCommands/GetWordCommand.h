...
#ifndef ONH_PARSER_PARSERCOMMANDS_GETWORDCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_GETWORDCOMMAND_H_
...
/**
 * Parser GET_WORD command
 */
class GetWordCommand: public IParserCommand {
	public:
		/**
		 * GET_WORD command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		GetWordCommand(std::shared_ptr<ParserDB> parserDB,
		 ...
		 * Command Destructor
		 */
		virtual ~GetWordCommand() = default;
...
#endif  // ONH_PARSER_PARSERCOMMANDS_GETWORDCOMMAND_H_
