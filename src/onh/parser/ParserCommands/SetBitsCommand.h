...
#ifndef ONH_PARSER_PARSERCOMMANDS_SETBITSCOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_SETBITSCOMMAND_H_
...
/**
 * Parser SET_BITS command
 */
class SetBitsCommand: public IParserCommand {
	public:
		/**
		 * SET_BITS command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		SetBitsCommand(std::shared_ptr<ParserDB> parserDB,
		 ...
		 * Command Destructor
		 */
		virtual ~SetBitsCommand() = default;
...
#endif  // ONH_PARSER_PARSERCOMMANDS_SETBITSCOMMAND_H_
