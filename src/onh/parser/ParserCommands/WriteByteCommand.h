...
#ifndef ONH_PARSER_PARSERCOMMANDS_WRITEBYTECOMMAND_H_
#define ONH_PARSER_PARSERCOMMANDS_WRITEBYTECOMMAND_H_
...
/**
 * Parser WRITE_BYTE command
 */
class WriteByteCommand: public IParserCommand {
	public:
		/**
		 * WRITE_BYTE command constructor
		 *
		 * @param parserDB Parser database
		 * @param pr Process reader
		 * @param commandData String with command data
		 */
		WriteByteCommand(std::shared_ptr<ParserDB> parserDB,
		 ...
		 * Command Destructor
		 */
		virtual ~WriteByteCommand() = default;
...
#endif  // ONH_PARSER_PARSERCOMMANDS_WRITEBYTECOMMAND_H_
