...
#ifndef ONH_DRIVER_DRIVERMANAGER_H_
#define ONH_DRIVER_DRIVERMANAGER_H_
...
class DriverManager {
	public:
		 ...
		 */
		explicit DriverManager(const std::vector<DriverConnection>& dcv);
...
#endif  // ONH_DRIVER_DRIVERMANAGER_H_
